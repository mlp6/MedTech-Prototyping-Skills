...
<!-- TODO: update to GitHub Quarto links
...
| Firmware Development: Button Event ISRs, ADC & State Machines | None | [Button Event ISR & ADC](https://gitlab.oit.duke.edu/MedTechPrototyping/arduino_isr_adc) (Paired Coding) |
| [Lightbox Project (Kanban Board)](https://trello.com/b/3vtxGG3U/lightbox) | None | [Lightbox Project Repository](https://gitlab.oit.duke.edu/kits/BME-254L-001-Sp25/lightbox) |
-->
...
- Lightbox Project (Kanban Board)
- Firmware Development: C Programming Overview
- Firmware Development: Button Event ISRs, ADC & State Machines
...
while will kickstart your efforts for your project.  Lab time will provide you
