...
- [Teams](https://teams.microsoft.com) (fastest response time)

- [Email](mailto:mark.palmeri@duke.edu) (24-48 hour response time)

- [Office Hours](https://calendly.com/mark-palmeri)

### Teaching Assistants

- [Yasha Saxena](mailto:yasha.saxena@duke.edu)

::: callout-tip
Questions that can be answered by Dr. Palmeri or a teaching assistant should be
sent via Teams or email.
:::

## Course Times & Locations

**Lecture:** Tuesday & Thursday, 11:45-13:00, Hudson Hall 139 (Panopto recorded)

**Lab:** As needed, Teer 212 (Door Code: TBA)

There are no formally scheduled lab sections, but you will need to use the lab
equipment to perform testing of your devices.  Sometimes lecture will be held in
lab. Your TAs will announce times when they will hold lab hours.  Lab is
available whenever classes are not scheduled in the space (posted on the lab
door).
...
dates for assignments associated with each module will be posted to Canvas.
...
All assignment grades will be posted to Canvas throughout the
...
assignment being released**. You must make the request via Canvas and
