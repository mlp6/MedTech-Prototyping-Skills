...
\begin{itemize}
    ...
    \item Add your full name or Net ID to one Cu layer of the board
...
\centerline{\includegraphics[width=1.0\textwidth]{pcb_pdf_plot.png}}
...
\centerline{\includegraphics[width=0.5\textwidth]{example_F_Cu.png}}
\centerline{\includegraphics[width=0.5\textwidth]{example_B_Cu.png}}
