...
\begin{itemize}
    ...
    \item Ergonomics / aesthetics. Try to avoid corners and straigh edges. Curves are good (and not sharp).
...
For the specifcations that could be optimized (e.g., size, weight, etc.) comment
...
In this report, include testing data of the same LED outputs as your did for the
discrete electronics version of your device.

Please include a discussion of the "pros" and "cons" of implementing the desired
LED functions using discrete electronics versus a microcontroller.
