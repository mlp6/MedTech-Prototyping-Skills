...
format:
  live-html: 
    output-file: EDA-KiCad-SPICE-notes.html
  live-revealjs: 
    output-file: EDA-KiCad-SPICE-slides.html
---
...
- [Voltage Divider with Potentiometer (DC Sweep)](https://github.com/mlp6/MedTech-Prototyping-Skills/tree/main/kicad/voltage_divider)

- [RC Filter (AC Sweep)](https://github.com/mlp6/MedTech-Prototyping-Skills/tree/main/kicad/active_lpf)

- [RC Filter (Transient Analysis)](https://github.com/mlp6/MedTech-Prototyping-Skills/tree/main/kicad/RC_AC_Transient)

- [RC Filter (Switched, Transient Analysis)](https://github.com/mlp6/MedTech-Prototyping-Skills/tree/main/kicad/RC_Switched)
