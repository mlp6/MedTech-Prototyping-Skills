...
\begin{frame}{What is a microcontroller?}
    ...
    \begin{columns}
        ...
        \end{column}
        \begin{column}{0.5\textwidth}
            \centerline{\includegraphics[width=1.0\textwidth]{ic.png}}             
        \end{column}
    \end{columns}
\end{frame}
...
\centerline{\includegraphics[width=0.5\textwidth]{consumer_electronics.png}}
...
\end{itemize}
    \end{column}
    \begin{column}{0.5\textwidth}
       \centerline{\includegraphics[width=1.0\textwidth]{medical_devices.png}} 
    \end{column}
\end{columns}
...
\centerline{\includegraphics[width=0.6\textwidth]{arduino.png}}
\end{frame}
...
\begin{frame}{High Level Languages}
    \centerline{\includegraphics[width=0.7\textwidth]{high-level-langauge.png}}
\end{frame}

\begin{frame}{Assembly Languages}
    \centerline{\includegraphics[width=0.7\textwidth]{assembly-language.png}}
\end{frame}

\begin{frame}{Machine Languages}
    \centerline{\includegraphics[width=0.7\textwidth]{machine-language.png}}
\end{frame}

\begin{frame}{Hardware Languages}
    \centerline{\includegraphics[width=0.7\textwidth]{hardware-language.png}}
\end{frame}
...
\begin{frame}{IDE}
    ...
    \centerline{\includegraphics[width=0.6\textwidth]{ide.png}}

\end{frame}

\begin{frame}{Shields}

    \centerline{\includegraphics[width=1.0\textwidth]{shields.png}}
...
\begin{frame}{ECG}
    ...
    \centerline{\includegraphics[width=0.6\textwidth]{ecg.png}}

\end{frame}

\begin{frame}{Pulse Oximeter}

    \centerline{\includegraphics[width=0.7\textwidth]{pulse_ox.png}}
...
\begin{frame}{Fun Examples}
    ...
    \begin{itemize}
        ...
        \item \href{https://www.youtube.com/watch?v=BNBIdVR95V0}{Beer Launcher Fridge}
    \end{itemize}
...
\begin{frame}{In-Class Exercise}
    ...
    Create block diagram of the light enclosure device for a microcontroller.
