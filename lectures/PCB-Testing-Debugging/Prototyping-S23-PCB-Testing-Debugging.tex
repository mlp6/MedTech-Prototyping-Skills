...
\title[PCB Testing \& Debugging]{PCB Testing \& Debugging}
...
\begin{frame}{PCB Revisions}
    \begin{columns}
        ...
        \end{column}
        \begin{column}{0.5\textwidth}
            \centerline{\includegraphics[width=1.0\textwidth]{changelog.png}}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Bug 1: Voltage Source}
    ...
    \begin{columns}
        ...
        \begin{column}{0.6\textwidth}
            \centerline{\includegraphics[width=1.0\textwidth]{pwr_ckt.png}}
        \end{column}
    \end{columns}
...
\begin{frame}{Bug 2: Astable Oscillator Potentiometer}
    ...
    \centerline{\includegraphics[width=0.7\textwidth]{astable_pot_fix.png}}
...
\begin{frame}{Connectivity Testing}
    \begin{columns}
        ...
        \end{column}
        \begin{column}{0.5\textwidth}
            \centerline{\includegraphics[width=1.0\textwidth]{ground_islands.png}}    
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Test Timers}
    ...
    \begin{columns}
        ...
        \end{column}
        \begin{column}{0.5\textwidth}
            \centerline{\includegraphics[width=0.8\textwidth]{schematic_timers.png}} 
        \end{column}
    \end{columns}
...
\begin{frame}{Test Points}
    \centerline{\includegraphics[width=0.6\textwidth]{schematic_root.png}}
\end{frame}
...
\begin{frame}{ADALM2000}
    ...
    We are short on some bench equipment, but we have some USB-based testing equipment to use!
        ...
        \end{column}
        \begin{column}{0.5\textwidth}
    \centerline{\includegraphics[width=0.5\textwidth]{adalm2000.jpg}}
...
\begin{frame}{Scopy}
    ...
    \begin{columns}
        ...
        \end{column}
        \begin{column}{0.5\textwidth}
            \centerline{\includegraphics[width=0.75\textwidth]{scopy.png}}
        \end{column}
    \end{columns}
