...
\begin{calendar}{1/09/2023}{16} 
	...
	\caltexton{13}{Timer Circuit Specifications / Testing}
	\caltexton{14}{Timer Circuit Testing}
	\caltexton{14}{\textbf{Lab:} Timer Circuit Validation}
	\caltexton{15}{Finalize PCBs / Submit for Fabrication}
	\caltexton{16}{Physical Enclosure: Fasteners, Panel-Mounted Components}
