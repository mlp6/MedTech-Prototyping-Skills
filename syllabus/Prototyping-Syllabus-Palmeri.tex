...
\begin{calendar}{1/09/2023}{16} 
    ...
    \caltexton{25}{Microcontroller Overview \& Functional Decomposition} 
    \caltexton{26}{Introduction to Firmware Development (PlatformIO)}
	\caltexton{26}{\textbf{Lab:} Project Time}
	\caltexton{27}{Version Control Overview (\texttt{git})}
	\caltexton{28}{Firmware Development}
